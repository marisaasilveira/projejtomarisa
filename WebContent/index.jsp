...
<body>
    ...
    <div class="d-flex align-items-center p-3 px-md-4 mb-3 border-bottom" style="background:rgb(243, 201, 95)">
        ...
        <nav>
            ...
            <a class="p-2 text-dark" href="#">Funcionarios</a>
            <a class="p-2 text-dark" href="#">Projetos</a>
            <a class="p-2 text-dark" href="#">Servicos</a>
        </nav>
        <a class="btn btn-secondary" href="sairLogin.jsp">Sair</a>
      </div>
      <div class="row" style="background: rgb(47, 100, 116); color: white;">
          <div class="px-3 py-3 pt-md-5 pb-md-4 mx-auto text-center">
              <h1 class="display-4"> Conheça um pouco da gente </h1>
              <p class="lead"> Trabalhamos com instalação de máquinas e equipamentos industriais</p>
              <p class="small">Nossa empresa fica localiza em Santa Brígida - Ba </p>
            </div>
      </div>
      <div class="p-4"></div>
      ...
      <blockquote class="blockquote text-center" >
        <h1>Quem Somos</h1>
        <p class="mb-0">A ENGMIX CONSULTORIA PROJETOS E SERVIÇOS LTDA, É UMA EMPRESA DE ENGENHARIA E PRESTAÇÃO DE SERVIÇOS,
           FOCADA EM ATENDER AS NECESSIDADES DE NOSSOS CLIENTES E PARCEIROS, DISPOMOS DE UMA AMPLA REDE DE PROFISSIONAIS E
            DESENVOLVER SOLUÇÕES COM BAIXO CUSTO E MANTENDO ALTO NÍVEL DE QUALIDADE, RESPEITANDO 
          AS NORMAS E PROCEDIMENTOS DE SEGURANÇA E MEIO AMBIENTE, BUSCANDO SEMPRE SUPERAR AS EXPECTATIVAS DOS NOSSOS CLIENTES.</p>
      </blockquote>
      <blockquote class="blockquote text-right">
        <h3>Nossa Missão</h3> 
          <p class="mb-0">Buscar através da engenharia oportunidades para <br>
                          solucionar problemas  que nos afeta no dia a dia, <br>
                         proporcionando  a sociedade mais qualidade de vida, <br>
                         e aos nossos clientes mais tranquilidade, segurança e eficiência.</p>
        </blockquote>
        <blockquote class="blockquote">
          <h3>Visão</h3>
            <p class="mb-0">Ser reconhecida como empresa de excelência nas areas atuantes de consultorias,<br>
               treinamentos, projetos e Serviços, porque a satisfação total <br>
               de nossos clientes é o nosso principal objetivos.</p>
          </blockquote>
          <blockquote class="blockquote text-center">
            <h3>Valores</h3>
            <ul>
